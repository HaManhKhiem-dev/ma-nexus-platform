  ...
  "en": {
    "translation": {
      ...
      "auth": {
        ...
        "forgot_password_description": "Enter your corporate email address to receive a secure password reset link.",
  ...
  "vi": {
    "translation": {
      ...
      "auth": {
        ...
        "reset_success": "Đã gửi liên kết khôi phục mật khẩu! Vui lòng kiểm tra hộp thư của bạn.",
        "back_to_login": "Quay lại đăng nhập",
        "title_forgot_password": "Đặt lại mật khẩu",
        "forgot_password_description": "Nhập email doanh nghiệp của bạn để nhận liên kết khôi phục mật khẩu bảo mật.",
